...
/***/ function(module, exports, __webpack_require__) {
	...
	var record_1 = __webpack_require__(8);
	var react_bootstrap_1 = __webpack_require__(9);
	var react_bootstrap_2 = __webpack_require__(9);
	var react_bootstrap_3 = __webpack_require__(9);
	var TestGet = (function (_super) {
	    __extends(TestGet, _super);
	    function TestGet() {
	        _super.call(this);
	        this.state = {
	            path: 'list',
	    ...
	    TestGet.prototype.update = function (e) {
	        if (e.folder) {
	            this.setState({
	    ...
	    TestGet.prototype.reset = function () {
	        this.setState({
	            path: 'list',
	            records: []
	        }, this.fillPage);
	    };
	    TestGet.prototype.componentWillMount = function () {
	        this.fillPage();
	    };
	    TestGet.prototype.fillPage = function () {
	        var _this = this;
	        console.log('start' + " " + this.state.path);
	        ajax.get('/files/' + this.state.path).end(function (err, response) {
	            if (!err && response) {
	                _this.setState({ "path": _this.state.path, records: JSON.parse(response.text) });
	            }
	            else {
	                console.log(err);
	            }
	    ...
	    TestGet.prototype.render = function () {
	        var _this = this;
	        var files = this.state.records.map(function (rec) {
	            return React.createElement(record_1.Record, {key: rec.id, data: rec, click: _this.update});
	        });
	        return (React.createElement(react_bootstrap_2.Grid, null, React.createElement(react_bootstrap_1.Table, null, React.createElement("thead", null, React.createElement("tr", null, React.createElement("th", null, "Name"), React.createElement("th", null, "Children"), React.createElement("th", null, "Type"), React.createElement("th", null, "Trashed"))), React.createElement("tbody", null, files)), React.createElement(react_bootstrap_3.Button, {onClick: this.reset}, "Home")));
	    };
	    return TestGet;
	}(React.Component));
	ReactDOM.render(React.createElement(TestGet, null), document.getElementById("app"));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Record = (function (_super) {
	    ...
	    Record.prototype.render = function () {
	        return (
	        // <tr onClick={() => { this.props.click(this.props.data) } }>
	        //     <td>{this.props.data.name}</td>
	        //     <td>Children: {this.props.data.children}</td>
	        //     <td>{this.props.data.folder ? "folder" : "file"}</td>
	        //     <td>{this.props.data.trashed ? "yes" : "no"}</td>
	        // </tr>
	        (this.props.data.folder) ? React.createElement(Folder, __assign({}, this.props)) : React.createElement(File, __assign({}, this.props.data)));
	    };
	    return Record;
	}(React.Component));
	exports.Record = Record;
	var File = function (props) { return (React.createElement("tr", null, React.createElement("td", null, props.name), React.createElement("td", null, "Children: ", props.children), React.createElement("td", null, props.folder ? "folder" : "file"), React.createElement("td", null, props.trashed ? "yes" : "no"))); };
	var Folder = function (props) { return (React.createElement("tr", {onClick: function () { props.click(props.data); }}, React.createElement("td", null, props.data.name), React.createElement("td", null, "Children: ", props.data.children), React.createElement("td", null, props.data.folder ? "folder" : "file"), React.createElement("td", null, props.data.trashed ? "yes" : "no"))); };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Accordion2 = __webpack_require__(10);
	
	var _Accordion3 = _interopRequireDefault(_Accordion2);
	
	var _Alert2 = __webpack_require__(107);
	
	var _Alert3 = _interopRequireDefault(_Alert2);
	
	var _Badge2 = __webpack_require__(111);
	
	var _Badge3 = _interopRequireDefault(_Badge2);
	
	var _Breadcrumb2 = __webpack_require__(112);
	
	var _Breadcrumb3 = _interopRequireDefault(_Breadcrumb2);
	
	var _BreadcrumbItem2 = __webpack_require__(113);
	
	var _BreadcrumbItem3 = _interopRequireDefault(_BreadcrumbItem2);
	
	var _Button2 = __webpack_require__(117);
	
	var _Button3 = _interopRequireDefault(_Button2);
	
	var _ButtonGroup2 = __webpack_require__(118);
	
	var _ButtonGroup3 = _interopRequireDefault(_ButtonGroup2);
	
	var _ButtonToolbar2 = __webpack_require__(120);
	
	var _ButtonToolbar3 = _interopRequireDefault(_ButtonToolbar2);
	
	var _Carousel2 = __webpack_require__(121);
	
	var _Carousel3 = _interopRequireDefault(_Carousel2);
	
	var _CarouselItem2 = __webpack_require__(123);
	...
	var _PanelGroup2 = __webpack_require__(94);
	...
	var _SafeAnchor2 = __webpack_require__(114);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _PanelGroup = __webpack_require__(94);
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(20)(IteratorPrototype, __webpack_require__(65)('iterator'), function(){ return this; });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _bootstrapUtils = __webpack_require__(97);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _BreadcrumbItem = __webpack_require__(113);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _SafeAnchor = __webpack_require__(114);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _all = __webpack_require__(119);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _CarouselCaption = __webpack_require__(122);
	
	var _CarouselCaption2 = _interopRequireDefault(_CarouselCaption);
	
	var _CarouselItem = __webpack_require__(123);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var on = __webpack_require__(144),
	    ...
	    filter = __webpack_require__(199);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  addClass: __webpack_require__(208),
	  removeClass: __webpack_require__(210),
	  hasClass: __webpack_require__(209)
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';
	var hasClass = __webpack_require__(209);
...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';
	var contains = __webpack_require__(148),
	    getWindow = __webpack_require__(212),
...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';
	var getWindow = __webpack_require__(212);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _bootstrapUtils2 = __webpack_require__(97);
	
	var _bootstrapUtils = _interopRequireWildcard(_bootstrapUtils2);
	
	var _createChainedFunction2 = __webpack_require__(105);
	
	var _createChainedFunction3 = _interopRequireDefault(_createChainedFunction2);
	
	var _ValidComponentChildren2 = __webpack_require__(106);
